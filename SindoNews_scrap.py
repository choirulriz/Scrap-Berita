...
try:
	html = urlopen("https://nasional.sindonews.com/politik").read()
...
indeksPilpres = soup.find(class_="grid_24").find_all('a', href = re.compile('https://nasional\.sindonews\.com/read/')) #Find All menghasilkan list
